...
/* Most of this file is automatically generated from the Scintilla.iface interface
 * definition file which contains any comments about the definitions. ScintillaAPIFacer.py
 * does the generation. */
...
constexpr RepresentationAppearance operator|(RepresentationAppearance a,
                                             RepresentationAppearance b) noexcept {
...
constexpr LineCharacterIndexType operator|(LineCharacterIndexType a,
                                           LineCharacterIndexType b) noexcept {
...
inline ModificationFlags &operator|=(ModificationFlags &self,
                                     ModificationFlags a) noexcept {
  self = self | a;
  return self;
}
...
constexpr KeyMod ModifierFlags(bool shift, bool ctrl, bool alt, bool meta = false,
                               bool super = false) noexcept {
  return (shift ? KeyMod::Shift : KeyMod::Norm) | (ctrl ? KeyMod::Ctrl : KeyMod::Norm) |
         (alt ? KeyMod::Alt : KeyMod::Norm) | (meta ? KeyMod::Meta : KeyMod::Norm) |
         (super ? KeyMod::Super : KeyMod::Norm);
}

// Test if an enum class value has some bit flag(s) of test set.
template <typename T> constexpr bool FlagSet(T value, T test) {
