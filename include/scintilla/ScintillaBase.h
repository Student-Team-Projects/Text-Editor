...
class ScintillaBase : public Editor, IListBoxDelegate {
  ...
  Scintilla::MultiAutoComplete
      multiAutoCMode; /// Mode for autocompleting when multiple selections are present
  ...
  void AutoCompleteInsert(Sci::Position startPos, Sci::Position removeLen,
  ...
  void AutoCompleteNotifyCompleted(char ch, CompletionMethods completionMethod,
                                   Sci::Position firstPos, const char *text);
  ...
  void ButtonDownWithModifiers(Point pt, unsigned int curTime,
  ...
  Scintilla::sptr_t WndProc(Scintilla::Message iMessage, Scintilla::uptr_t wParam,
