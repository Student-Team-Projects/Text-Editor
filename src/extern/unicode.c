 ...
 */
int utf_string_dsplen(const char *s, size_t max_bytes) {
    int result = 0;
    const char *ptr = s;
 ...
 *
 */
int readline_utf_string_dsplen(const char *s, size_t max_bytes, size_t offset) {
    int result = 0;
    const char *ptr = s;
