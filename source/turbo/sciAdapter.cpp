...
std::array<std::array<int, 2>, 2> SciAdapter::selection_points() {
  ...
  return {std::array<int, 2>{0, 0}, {0, 0}};
}
...
void SciAdapter::NotifyParent(NotificationData scn) {
  // WndProc(SCI_NOTIFY_PARENT, reinterpret_cast<sptr_t>(&scn), 0);
