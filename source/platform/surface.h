...
inline ColourDesired convertColor(TColorDesired c) { return ColourDesired(c.bitCast()); }

inline ushort getStyle(const Font &font) { return (ushort)(size_t)font.GetID(); }
